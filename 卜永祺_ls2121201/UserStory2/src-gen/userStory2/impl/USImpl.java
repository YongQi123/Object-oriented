 ...
 * </p>
 * <ul>
 *   <li>{@link userStory2.impl.USImpl#getUserstory <em>Userstory</em>}</li>
 *   <li>{@link userStory2.impl.USImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class USImpl extends MinimalEObjectImpl.Container implements US {
	...
	protected EClass eStaticClass() {
		return UserStory2Package.Literals.US;
	}
	...
	public EList<UserStory> getUserstory() {
		if (userstory == null) {
			userstory = new EObjectContainmentEList<UserStory>(UserStory.class, this, UserStory2Package.US__USERSTORY);
		}
		return userstory;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UserStory2Package.US__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case UserStory2Package.US__USERSTORY:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case UserStory2Package.US__USERSTORY:
			return getUserstory();
		case UserStory2Package.US__NAME:
			return getName();
		}
