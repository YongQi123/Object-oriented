...
public class PortItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SoamlPackage.Literals.PORT__REQUEST);
			childrenFeatures.add(SoamlPackage.Literals.PORT__SERVICE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(SoamlPackage.Literals.PORT__REQUEST, SoamlFactory.eINSTANCE.createRequest()));

		newChildDescriptors
				.add(createChildParameter(SoamlPackage.Literals.PORT__SERVICE, SoamlFactory.eINSTANCE.createService()));
	}
