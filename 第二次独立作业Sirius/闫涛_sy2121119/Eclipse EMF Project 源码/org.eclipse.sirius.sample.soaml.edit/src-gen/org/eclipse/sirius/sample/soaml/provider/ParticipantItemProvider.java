...
public class ParticipantItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SoamlPackage.Literals.PARTICIPANT__PROVIDER);
			childrenFeatures.add(SoamlPackage.Literals.PARTICIPANT__AGENT);
			childrenFeatures.add(SoamlPackage.Literals.PARTICIPANT__CONSUMER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SoamlPackage.Literals.PARTICIPANT__PROVIDER,
				SoamlFactory.eINSTANCE.createProvider()));

		newChildDescriptors.add(
				createChildParameter(SoamlPackage.Literals.PARTICIPANT__AGENT, SoamlFactory.eINSTANCE.createAgent()));

		newChildDescriptors.add(createChildParameter(SoamlPackage.Literals.PARTICIPANT__CONSUMER,
				SoamlFactory.eINSTANCE.createConsumer()));
	}
