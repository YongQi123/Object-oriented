...
public class ServiceItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(SoamlPackage.Literals.SERVICE__SERVICEINTERFACE);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case SoamlPackage.SERVICE__SERVICEINTERFACE:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(SoamlPackage.Literals.SERVICE__SERVICEINTERFACE,
				SoamlFactory.eINSTANCE.createServiceInterface()));
	}
