...
public class SoamlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SoamlPackage.SOA_ML: {
			SoaML soaML = (SoaML) theEObject;
			T result = caseSoaML(soaML);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Soa ML</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Soa ML</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSoaML(SoaML object) {
		return null;
	}
