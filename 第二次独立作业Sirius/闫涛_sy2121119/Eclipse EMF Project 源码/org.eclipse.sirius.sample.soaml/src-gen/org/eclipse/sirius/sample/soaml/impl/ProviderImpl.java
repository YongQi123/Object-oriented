 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.soaml.impl.ProviderImpl#getMessage <em>Message</em>}</li>
 *   <li>{@link org.eclipse.sirius.sample.soaml.impl.ProviderImpl#getService <em>Service</em>}</li>
 *   <li>{@link org.eclipse.sirius.sample.soaml.impl.ProviderImpl#getServicecontract <em>Servicecontract</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProviderImpl extends MinimalEObjectImpl.Container implements Provider {
	...
	public EList<Message> getMessage() {
		if (message == null) {
			message = new EObjectContainmentEList<Message>(Message.class, this, SoamlPackage.PROVIDER__MESSAGE);
		}
		return message;
	}
	...
	public EList<Service> getService() {
		if (service == null) {
			service = new EObjectContainmentEList<Service>(Service.class, this, SoamlPackage.PROVIDER__SERVICE);
		}
		return service;
	}
	...
	public EList<ServiceContract> getServicecontract() {
		if (servicecontract == null) {
			servicecontract = new EObjectContainmentEList<ServiceContract>(ServiceContract.class, this,
					SoamlPackage.PROVIDER__SERVICECONTRACT);
		}
