 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.soaml.impl.RequestImpl#getServiceinterface <em>Serviceinterface</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RequestImpl extends MinimalEObjectImpl.Container implements Request {
	/**
	 * The cached value of the '{@link #getServiceinterface() <em>Serviceinterface</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public EList<ServiceInterface> getServiceinterface() {
		if (serviceinterface == null) {
			serviceinterface = new EObjectContainmentEList<ServiceInterface>(ServiceInterface.class, this,
					SoamlPackage.REQUEST__SERVICEINTERFACE);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SoamlPackage.REQUEST__SERVICEINTERFACE:
