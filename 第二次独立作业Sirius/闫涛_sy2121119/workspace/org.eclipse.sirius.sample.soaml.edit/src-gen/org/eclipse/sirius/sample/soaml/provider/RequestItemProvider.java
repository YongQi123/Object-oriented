...
public class RequestItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addServiceinerfacePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Request_serviceinerface_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Request_serviceinerface_feature",
								"_UI_Request_type"),
						SoamlPackage.Literals.REQUEST__SERVICEINERFACE, true, false, true, null, null, null));
	}
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Request_port_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Request_port_feature", "_UI_Request_type"),
						SoamlPackage.Literals.REQUEST__PORT, true, false, true, null, null, null));
	}
