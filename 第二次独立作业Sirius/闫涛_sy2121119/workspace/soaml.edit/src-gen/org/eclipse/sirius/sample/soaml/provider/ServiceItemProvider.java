 ...
 * @generated
 */
public class ServiceItemProvider extends PortItemProvider {
	/**
	...
	protected void addServiceinterfacePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Service_serviceinterface_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Service_serviceinterface_feature",
								"_UI_Service_type"),
						SoamlPackage.Literals.SERVICE__SERVICEINTERFACE, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Service_type") + " " + service.isConnectorRequired();
	}
