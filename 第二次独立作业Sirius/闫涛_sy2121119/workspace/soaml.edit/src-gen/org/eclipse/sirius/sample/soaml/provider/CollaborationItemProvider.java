...
public class CollaborationItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIsStrictPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Collaboration_isStrict_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Collaboration_isStrict_feature",
								"_UI_Collaboration_type"),
						SoamlPackage.Literals.COLLABORATION__IS_STRICT, true, false, false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Collaboration_type") + " " + collaboration.isIsStrict();
	}
