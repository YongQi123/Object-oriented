 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.sirius.sample.soaml.impl.CapabilityRealizationImpl#getCapability <em>Capability</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CapabilityRealizationImpl extends MinimalEObjectImpl.Container implements CapabilityRealization {
	/**
	...
	protected EClass eStaticClass() {
		return SoamlPackage.Literals.CAPABILITY_REALIZATION;
	}
			...
			if (capability != oldCapability) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SoamlPackage.CAPABILITY_REALIZATION__CAPABILITY, oldCapability, capability));
			}
		}
		return capability;
	}
	...
	public void setCapability(Capability newCapability) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SoamlPackage.CAPABILITY_REALIZATION__CAPABILITY,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SoamlPackage.CAPABILITY_REALIZATION__CAPABILITY:
			if (resolve)
