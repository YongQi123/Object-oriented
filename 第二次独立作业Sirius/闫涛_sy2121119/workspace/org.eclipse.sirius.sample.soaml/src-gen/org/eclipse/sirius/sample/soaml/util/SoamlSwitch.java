...
public class SoamlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case SoamlPackage.CAPABILITY_EXPOSURE: {
			CapabilityExposure capabilityExposure = (CapabilityExposure) theEObject;
			T result = caseCapabilityExposure(capabilityExposure);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SoamlPackage.SERVICE_INERFACE: {
			ServiceInerface serviceInerface = (ServiceInerface) theEObject;
			T result = caseServiceInerface(serviceInerface);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case SoamlPackage.SERVICE_ARCHITECTURE: {
			...
			if (result == null)
				result = caseCollaboration(serviceArchitecture);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case SoamlPackage.SERVICE_CONTRACT: {
			...
			if (result == null)
				result = caseCollaboration(serviceContract);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Capability Exposure</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Capability Exposure</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseCapabilityExposure(CapabilityExposure object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Service Inerface</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Service Inerface</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseServiceInerface(ServiceInerface object) {
		return null;
	}
