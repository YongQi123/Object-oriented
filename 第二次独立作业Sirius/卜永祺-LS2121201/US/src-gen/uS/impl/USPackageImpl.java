...
public class USPackageImpl extends EPackageImpl implements USPackage {
	...
	public static USPackage init() {
		if (isInited)
			return (USPackage) EPackage.Registry.INSTANCE.getEPackage(USPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredUSPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		USPackageImpl theUSPackage = registeredUSPackage instanceof USPackageImpl ? (USPackageImpl) registeredUSPackage
				: new USPackageImpl();
	 ...
	 * @generated
	 */
	public EReference getRefinement_Target() {
	...
	public EReference getUS_Role() {
		return (EReference) usEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getUS_Refinement() {
	 ...
	 * @generated
	 */
	public EReference getRole_Userstory() {
	 ...
	 * @generated
	 */
	public EReference getFeature_Task() {
	 ...
	 * @generated
	 */
	public EReference getFeature_Goal() {
	 ...
	 * @generated
	 */
	public EReference getScenario_Event() {
	...
	public void createPackageContents() {
		...
		createEReference(refinementEClass, REFINEMENT__TARGET);

		usEClass = createEClass(US);
		createEReference(usEClass, US__USERSTORY);
		createEReference(usEClass, US__ROLE);
		createEReference(usEClass, US__REFINEMENT);

		roleEClass = createEClass(ROLE);
		createEAttribute(roleEClass, ROLE__NAME);
		createEReference(roleEClass, ROLE__USERSTORY);
		...
		createEReference(featureEClass, FEATURE__TASK);
		createEReference(featureEClass, FEATURE__GOAL);

		scenarioEClass = createEClass(SCENARIO);
		createEAttribute(scenarioEClass, SCENARIO__NAME);
		createEReference(scenarioEClass, SCENARIO__PRECONDITION);
		createEReference(scenarioEClass, SCENARIO__EVENT);
		createEReference(scenarioEClass, SCENARIO__POSTCONDITION);
	...
	public void initializePackageContents() {
		...
		orEClass.getESuperTypes().add(this.getRefinement());
		andEClass.getESuperTypes().add(this.getRefinement());
		containEClass.getESuperTypes().add(this.getRefinement());

		// Initialize classes, features, and operations; add parameters
		initEClass(refinementEClass, Refinement.class, "Refinement", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRefinement_Source(), this.getUserStory(), null, "source", null, 0, 1, Refinement.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRefinement_Target(), this.getUserStory(), null, "target", null, 0, 1, Refinement.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(usEClass, uS.US.class, "US", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUS_Userstory(), this.getUserStory(), null, "userstory", null, 0, -1, uS.US.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUS_Role(), this.getRole(), null, "role", null, 0, -1, uS.US.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getUS_Refinement(), this.getRefinement(), null, "refinement", null, 0, -1, uS.US.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getRole_Userstory(), this.getUserStory(), null, "userstory", null, 0, -1, Role.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE,
				IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getFeature_Name(), ecorePackage.getEString(), "name", null, 0, 1, Feature.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFeature_Task(), this.getTask(), null, "task", null, 0, 1, Feature.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getFeature_Goal(), this.getGoal(), null, "goal", null, 0, 1, Feature.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEAttribute(getScenario_Name(), ecorePackage.getEString(), "name", null, 0, 1, Scenario.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScenario_Precondition(), this.getPreCondition(), null, "precondition", null, 0, 1,
				Scenario.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getScenario_Event(), this.getEvent(), null, "event", null, 0, 1, Scenario.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getScenario_Postcondition(), this.getPostCondition(), null, "postcondition", null, 0, 1,
				Scenario.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
