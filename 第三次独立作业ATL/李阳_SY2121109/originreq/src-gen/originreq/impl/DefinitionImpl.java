 ...
 * </p>
 * <ul>
 *   <li>{@link originreq.impl.DefinitionImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefinitionImpl extends MinimalEObjectImpl.Container implements Definition {
	...
	protected EClass eStaticClass() {
		return OriginreqPackage.Literals.DEFINITION;
	}
	...
	public EList<VariableDeclarationCS> getVariable() {
		if (variable == null) {
			variable = new EObjectContainmentEList<VariableDeclarationCS>(VariableDeclarationCS.class, this,
					OriginreqPackage.DEFINITION__VARIABLE);
		}
		return variable;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case OriginreqPackage.DEFINITION__VARIABLE:
