 ...
 * </p>
 * <ul>
 *   <li>{@link originreq.impl.WorkflowImpl#getName <em>Name</em>}</li>
 *   <li>{@link originreq.impl.WorkflowImpl#getParticipants <em>Participants</em>}</li>
 *   <li>{@link originreq.impl.WorkflowImpl#getPartitions <em>Partitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkflowImpl extends MinimalEObjectImpl.Container implements Workflow {
	...
	protected EClass eStaticClass() {
		return OriginreqPackage.Literals.WORKFLOW;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OriginreqPackage.WORKFLOW__NAME, oldName, name));
	}
	...
	public EList<Participant> getParticipants() {
		if (participants == null) {
			participants = new EObjectResolvingEList<Participant>(Participant.class, this,
					OriginreqPackage.WORKFLOW__PARTICIPANTS);
		}
		return participants;
	}
	...
	public EList<Partition> getPartitions() {
		if (partitions == null) {
			partitions = new EObjectContainmentEList<Partition>(Partition.class, this,
					OriginreqPackage.WORKFLOW__PARTITIONS);
		}
		return partitions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case OriginreqPackage.WORKFLOW__PARTITIONS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case OriginreqPackage.WORKFLOW__NAME:
			return getName();
		case OriginreqPackage.WORKFLOW__PARTICIPANTS:
